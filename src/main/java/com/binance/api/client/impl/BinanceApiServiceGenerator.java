...
public class BinanceApiServiceGenerator {
   ...
   */
  public static <S> S createService(Class<S> serviceClass, String apiKey, String secret, OkHttpClient client) {
    String baseUrl = null;
  ...
  public static <S> S createService(Class<S> serviceClass, String apiKey, String secret) {
    return createService(serviceClass, apiKey, secret, sharedClient);
  }
